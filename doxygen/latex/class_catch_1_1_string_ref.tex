...
auto {\bfseries is\+Owned} () const noexcept -\/$>$ bool
\item 
...
auto {\bfseries is\+Substring} () const noexcept -\/$>$ bool
\end{DoxyCompactItemize}
...
char const  $\ast$ {\bfseries m\+\_\+start}
\item 
...
char $\ast$ {\bfseries m\+\_\+data} = nullptr
\end{DoxyCompactItemize}
